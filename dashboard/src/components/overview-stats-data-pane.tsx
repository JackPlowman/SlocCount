...
export default function OverviewStatsDataPane(): React.JSX.Element {
  const total = repoData.total;
  return (
    <main className="relative z-10 flex-1 flex justify-center items-center">
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-10 flex flex-col gap-8 min-w-[850px] min-h-[550px]">
        <h2 className="text-2xl font-semibold mb-4 self-center">
          Overview Statistics
        </h2>
        {/* Total Lines and Files Changed */}
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-gray-100 rounded-lg flex flex-col items-center justify-center h-24 text-lg font-semibold border border-gray-300">
            Total Files:
            <span className="text-2xl font-bold mt-1">{total.files}</span>
          </div>
          <div className="bg-gray-100 rounded-lg flex flex-col items-center justify-center h-24 text-lg font-semibold border border-gray-300">
            Total Lines:
            <span className="text-2xl font-bold mt-1">{total.lines}</span>
          </div>
          <div className="bg-gray-100 rounded-lg flex flex-col items-center justify-center h-24 text-lg font-semibold border border-gray-300">
